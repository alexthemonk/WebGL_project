...
function initVerts3() {
  ...
  g_cylinderVertAry = makeCylinder3();

  g_giraffeBodyVertAry = makeCylinder3();
  g_giraffeLegVertAry = makeCylinder3();
  g_giraffeHeadVertAry = makeSphere3();
  g_giraffeEarVertAry = makeCone3();
...
VBObox2.prototype.draw = function() {
  ...
  this.worldLight.translate(g_worldLightDirection);
...
VBObox2.prototype.drawSphere = function() {
  ...
  this.ModelMatrix.rotate(g_testAngle * 10, 0, 0, 1);
...
VBObox2.prototype.drawGiraffe = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox3.prototype.drawCylinder = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox3.prototype.drawGiraffe = function() {
  pushMatrix(this.ModelMatrix);
...
function VBObox4() {
  ...
  this.FRAG_SRC = //---------------------- FRAGMENT SHADER source code
    ...
    //
    "  float world_nDotL = max(dot(normalize(u_WorldLightDir), normal), 0.0); \n" +
    "  vec3 world_R = normalize(reflect(-u_WorldLightDir, normal)); \n" +
    "  float world_RDotV = max(dot(world_R, eyeDirection), 0.0); \n" +
    "  float world_e64 = pow(world_RDotV, u_Kshiny);\n" +
    //
    "	 vec3 world_emissive = u_Ke;" +
    "  vec3 world_ambient = u_WorldLightAmb * u_Ka;\n" +
    "  vec3 world_diffuse = u_WorldLightDiff * v_Kd * world_nDotL;\n" +
...
VBObox4.prototype.setView = function() {
  gl.viewport(
    0, // Viewport lower-left corner
    0, // location
    (g_canvas.width * 3) / 4, // viewport width,
...
VBObox4.prototype.drawSphere = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox4.prototype.drawDrone = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox4.prototype.drawFrog = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox4.prototype.drawCylinder = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox4.prototype.drawGiraffe = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox4.prototype.pushTriangleStrip = function(
  lightPosition,
  light,
  material,
  vertexStart,
...
VBObox5.prototype.setView = function() {
  gl.viewport(
    0, // Viewport lower-left corner
    0, // location
    (g_canvas.width * 3) / 4, // viewport width,
...
VBObox5.prototype.drawSphere = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox5.prototype.drawDrone = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox5.prototype.drawFrog = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox5.prototype.drawCylinder = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox5.prototype.drawGiraffe = function() {
  pushMatrix(this.ModelMatrix);
...
VBObox5.prototype.pushTriangleStrip = function(
  lightPosition,
  light,
  material,
  vertexStart,
