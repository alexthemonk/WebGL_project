...
function initVerts7() {
  ...
  g_giraffeBodyVertAry = makeCylinder7(LIGHT_GREY, BROWN, LIGHT_GREY, BROWN);
  g_giraffeLegVertAry = makeCylinder7(BROWN, DARK_GREY, BROWN, DARK_GREY);
  g_giraffeHeadVertAry = makeSphere7(BLACK, BLACK, BLACK);
  g_giraffeEarVertAry = makeCone7(BROWN, BLACK);

  g_frogHeadVertAry = makeSphere7(GREEN, GREEN, GREEN);
  g_frogEyeVertAry = makeSphere7(LIGHT_GREY, BLACK, BLACK);
  g_frogMouseVertAry = makeCurve7(BLUE);
...
VBObox2.prototype.init = function() {
  ...
  this.light.init("u_LightPos", "u_LightAmb", "u_LightDiff", "u_LightSpec");
...
VBObox2.prototype.pushTriangleStrip = function(
  ...
  this.light.translate(lightPosition);
