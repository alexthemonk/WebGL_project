...
function makeCone(walColr, botColr) {
...
function makeCylinder(topColr, walColr, botColr, ctrColr) {
  var capVerts = 20; // # of vertices around the topmost 'cap' of the shape
...
function makeCube(topColr, walColr, fntColr) {
...
function makeSphere(topColr, botColr, color) {
