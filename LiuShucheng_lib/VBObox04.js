...
function VBObox2() {
  ...
  // vertex array
  this.vboContents = makeSpherePos();
  ...
  this.u_KdLoc = false;
  this.u_LightPosLoc = false;
  this.u_LightAmbLoc = false;
  this.u_LightDiffLoc = false;
  this.u_LightSpecLoc = false;
  this.u_KeLoc = false;
  this.u_KaLoc = false;
  this.u_KsLoc = false;
...
VBObox2.prototype.init = function() {
  ...
  this.u_LightPosLoc = gl.getUniformLocation(gl.program, "u_LightPos");
  this.u_LightAmbLoc = gl.getUniformLocation(gl.program, "u_LightAmb");
  this.u_LightDiffLoc = gl.getUniformLocation(gl.program, "u_LightDiff");
  this.u_LightSpecLoc = gl.getUniformLocation(gl.program, "u_LightSpec");
  if (
    !this.u_LightPosLoc ||
    !this.u_LightAmbLoc ||
    !this.u_LightDiffLoc ||
  ...
  this.u_KshinyLoc = gl.getUniformLocation(gl.program, "u_Kshiny");
  if (
    !this.u_KeLoc ||
    !this.u_KaLoc ||
    !this.u_KdLoc ||
...
VBObox2.prototype.setView = function() {
  ...
  this.MvpMatrix.perspective(42.0, 1.0, 1.0, 1000.0);
...
VBObox2.prototype.draw = function() {
  ...
  gl.uniform3fv(this.u_LightPosLoc, g_freeCamPos);
  gl.uniform3f(this.u_LightAmbLoc, 0.5, 0.5, 0.5); // ambient
  gl.uniform3f(this.u_LightDiffLoc, 1.0, 1.0, 1.0); // diffuse
  gl.uniform3f(this.u_LightSpecLoc, 1.0, 1.0, 1.0); // Specular

  gl.uniform3f(this.u_KeLoc, 0.0, 0.0, 0.0); // Ke emissive
  gl.uniform3f(this.u_KaLoc, 0.0, 0.2, 0.0); // Ka ambient
  gl.uniform3f(this.u_KdLoc, 0.5, 0.0, 0.0); // Kd diffuse
  gl.uniform3f(this.u_KsLoc, 0.8, 0.8, 0.8); // Ks specular
  gl.uniform1f(this.u_KshinyLoc, 10.0); // Kshiny shinyness exponent
