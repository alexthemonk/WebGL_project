...
// Light Direction
g_worldLightDirection = [0.5, -0.5, 1.0, 0.0];
...
var g_LightingType = 0; // 0 for Phong, 1 for BlinnPhong
var g_ShadingType = 0; // 0 for Phong, 1 for Gouraud

// VBO boxes
var g_worldBox = new VBObox0();
var g_humanBox = new VBObox1();
var g_Phong_BlinnPhongBox = new VBObox2();
var g_Gouraud_BlinnPhongBox = new VBObox3();
var g_Phong_PhongBox = new VBObox4();
var g_Gouraud_PhongBox = new VBObox5();
...
function main() {
  ...
  g_Phong_PhongBox.init(gl);
  g_Gouraud_PhongBox.init(gl);
...
function drawAllVBO() {
  ...
  } else if (g_ShadingType == 1 && g_LightingType == 0) {
    // Gouraud shading and Blinn Phong lighting
    g_Gouraud_PhongBox.switchToMe();
    g_Gouraud_PhongBox.isReady();
    g_Gouraud_PhongBox.setView();
  } else if (g_ShadingType == 0 && g_LightingType == 0) {
    // Phong shading and Blinn Phong lighting
    g_Phong_PhongBox.switchToMe();
    g_Phong_PhongBox.isReady();
    g_Phong_PhongBox.setView();
  }
}
...
function switchWorldLight() {
  ...
  if (g_ShadingType == 0 && g_LightingType == 1) {
    g_Phong_BlinnPhongBox.worldLight.switch();
  }
  if (g_ShadingType == 1 && g_LightingType == 0) {
    g_Gouraud_PhongBox.worldLight.switch();
  }
  if (g_ShadingType == 0 && g_LightingType == 0) {
    g_Phong_PhongBox.worldLight.switch();
  }
}
...
function switchDroneLight() {
  ...
  if (g_ShadingType == 1 && g_LightingType == 0) {
    g_Gouraud_PhongBox.droneLight.switch();
  }
  if (g_ShadingType == 0 && g_LightingType == 0) {
    g_Phong_PhongBox.droneLight.switch();
  }
}
...
function changeShading() {
  ...
  if (g_ShadingType == 1 && g_LightingType == 1) {
    console.log("Switch to Gouraud Shading and Blinn Phong Lighting");
  }
  if (g_ShadingType == 0 && g_LightingType == 1) {
    console.log("Switch to Phong Shading and Blinn Phong Lighting");
  }
  if (g_ShadingType == 1 && g_LightingType == 0) {
    console.log("Switch to Gouraud Shading and Phong Lighting");
  }
  if (g_ShadingType == 0 && g_LightingType == 0) {
    console.log("Switch to Phong Shading and Phong Lighting");
  }
}
